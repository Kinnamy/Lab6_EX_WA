...
public class CookieUtil {
    ...
    public static void createCookie(HttpServletResponse response, 
        ...
        // 3. Set path to "/" (Available to the entire application)
        cookie.setPath("/");
        
        // 4. Set httpOnly to true (Prevents JavaScript from reading this cookie - Security)
    ...
    public static String getCookieValue(HttpServletRequest request, String name) {
        ...
        // 2. Check if cookies exist (getCookies returns null if empty)
        if (cookies != null) {
    ...
    public static void deleteCookie(HttpServletResponse response, String name) {
        ...
        // 2. Set maxAge to 0 (This tells the browser to expire/delete it immediately)
        cookie.setMaxAge(0);
        
        // 3. Set path to "/" (Must match the creation path to delete successfully)
        cookie.setPath("/");
    ...
    public static void updateCookie(HttpServletResponse response, 
                                   ...
                                   String newValue, 
                                   int maxAge) {
        // In HTTP, updating is the same as creating a new one with the same name
